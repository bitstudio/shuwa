        ...
        return new Promise(async (resolve) => {
            ...
            for (const image of imagestack) {
                ...
                for (let i = 0, n = POSE.keypoints.length; i < n; i += 1) {
                    if (
                        SELECTED_POSENET_JOINTS.includes(POSE.keypoints[i].part)
                    ) {
                ...
                this.faceObj.center = [
                    (this.faceObj.rightEarKeypoint[0] +
                        this.faceObj.leftEarKeypoint[0]) /
                        2,
                    (this.faceObj.rightEarKeypoint[1] +
                        this.faceObj.leftEarKeypoint[1]) /
                        2,
                ];
                ...
                const leftHandResult = await this.handPrediction(
                    ...
                    [
                        this.leftHand.center[0] / 257,
                        this.leftHand.center[1] / 257,
                    ],
                    imageInputTensor,
                );
                ...
                const rightHandResult = await this.handPrediction(
                    ...
                    [
                        this.rightHand.center[0] / 257,
                        this.rightHand.center[1] / 257,
                    ],
                    imageInputTensor,
                );
            ...
            // result to strings
            const predictionResult = wordResult[1].dataSync();
            ...
            resolve({
                resultLabel:
                    LABELS[
                        predictionResult.indexOf(Math.max(...predictionResult))
                    ],
